...
# Sampling parameters
prompt = "a bear is walking in a grass field"
batch_size = 1
guidance_scale = 5.0
...
save_images(source_image_256 * source_mask_256, "outputs/in_paint_mask.png")
...
# Show the output
save_images(samples, "outputs/in_paint_low.png")
...
# Show the output
save_images(up_samples, "outputs/in_paint_hi.png")
